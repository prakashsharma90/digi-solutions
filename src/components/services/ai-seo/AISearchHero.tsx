                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="lg:col-span-7 space-y-8">
                        ...
                        >
                            ...
                            <span className="text-sm font-semibold text-primary">AI Search Optimization</span>
                        </motion.div>
                        ...
                        >
                            ...
                            <p className="text-xl text-gray-400 leading-relaxed max-w-2xl">
                                LLM SEO for sustainable growth. We help brands appear in{" "}
                                <span className="text-white font-semibold">Google AI Overviews</span>,{" "}
                                <span className="text-white font-semibold">ChatGPT</span>, and{" "}
                                <span className="text-white font-semibold">Perplexity</span>{" "}
                                through authority-driven content, technical optimization, and entity SEO.
                            </p>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="text-sm">
                                    <div className="font-semibold text-white">Avg 3.2x</div>
                                    <div className="text-gray-500">Traffic Lift</div>
                                </div>
                            </div>
                            <div className="flex items-center gap-3">
                                ...
                                <div className="text-sm">
                                    ...
                                    <div className="text-gray-500">Ready Process</div>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="flex items-center gap-2">
                                ...
                                <span>No black-hat tactics</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <CheckCircle2 className="w-4 h-4 text-green-400" />
                        ...
                        <div className="relative">
                            ...
                            <div className="relative bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-xl rounded-2xl border border-white/10 p-6 shadow-2xl">
                                ...
                                <div className="flex items-center justify-between mb-6">
                                    <div>
                                        <h3 className="text-lg font-bold text-white">AI Search Performance</h3>
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-6">
                                    <div className="bg-black/40 rounded-xl p-4 border border-white/5">
                                        ...
                                        <div className="text-xs text-gray-400 mt-1">AI Citations</div>
                                        <div className="flex items-center gap-1 mt-2 text-green-400 text-xs">
                                            <TrendingUp className="w-3 h-3" />
                                            <span>+142% vs baseline</span>
                                        </div>
                                    </div>
                                    <div className="bg-black/40 rounded-xl p-4 border border-white/5">
                                        <div className="text-2xl font-bold text-white">3.2x</div>
                                        <div className="text-xs text-gray-400 mt-1">Traffic Lift</div>
                                        <div className="flex items-center gap-1 mt-2 text-green-400 text-xs">
                                            <TrendingUp className="w-3 h-3" />
                                ...
                                <div className="h-32 flex items-end justify-between gap-2">
                                    {[25, 35, 45, 50, 60, 70, 85, 90].map((height, i) => (
                            ...
                            {/* Floating Badge */}
                            <div className="absolute -bottom-4 -right-4 bg-gradient-to-br from-primary/20 to-purple-500/10 backdrop-blur-xl rounded-xl border border-primary/20 p-4 shadow-xl hidden lg:block">
                                <div className="text-xs text-gray-400 mb-1">Avg Result</div>
