                ...
                >
                    <div className="bg-gradient-to-br from-white/[0.08] to-white/[0.03] backdrop-blur-xl rounded-3xl border border-white/10 p-12 md:p-16 shadow-2xl">
                        ...
                        <p className="text-lg text-gray-400 mb-8 max-w-2xl mx-auto leading-relaxed">
                            Join 50+ brands already winning in AI search. Get your free visibility audit
                            and see exactly where you're losing traffic to competitors.
                        </p>

                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                            {[
                                { label: "Free audit worth ₹25,000", icon: "💰" },
                                { label: "48-hour turnaround", icon: "⚡" },
                        ...
                        <p className="text-sm text-gray-500 mt-8">
                            Typical response time: Under 2 hours • 50+ brands trust us • 4.9/5 rating
                        </p>
                    </div>
                </motion.div>
            </Container>
